    ...
    <div className={styles.container}>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.aboutContainer}>
          <p>
            Officia qui ut enim anim nostrud aliqua deserunt Lorem consectetur
            fugiat. Fugiat excepteur sit Lorem id deserunt. Ex consectetur dolor
            cillum aute enim officia officia. Esse dolor aute aute dolor commodo
            elit. Mollit aliquip consequat ipsum officia ea laborum do eiusmod
